package com.example.script.demo.qrcodelink;
...
public class QRCodeUtils {
     ...
     * 识别二维码
     */
    public static QRCodeResult QRReader(File file) throws IOException, NotFoundException {
        ...
        bufferedImage.flush();
        return new QRCodeResult(result.getBarcodeFormat().name(), result.getText());
    }
